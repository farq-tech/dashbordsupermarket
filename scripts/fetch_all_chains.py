...
# RID → brand mapping (Riyadh live compare: six chains — بنده = بنده إكسبرس نفس العلامة)
RETAILER_BRANDS = {
    1: {"ar": "كارفور", "en": "Carrefour"},
    2: {"ar": "بنده", "en": "Panda"},
    3: {"ar": "الدانوب", "en": "Danube"},
    4: {"ar": "التميمي", "en": "Tamimi Markets"},
