...
export function Topbar({ title_ar, title_en, subtitle_ar, subtitle_en }: TopbarProps) {
  const { lang, setLang, refreshing, forceRefresh, lastUpdated, selectedRetailer, dataSource, setDataSource } = useAppStore()
  ...
  return (
    ...
    >
      ...
      {/* Data source tabs: سوبرماركت | تطبيقات التوصيل */}
      <div
        className="flex shrink-0 items-center gap-0.5 p-1 rounded-lg border"
